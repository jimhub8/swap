...
<div>
    <v-menu offset-y id="menu_css" transition="scale-transition">
        ...
        <v-row @mouseleave="display_menu = false">
            <v-col sm="4" style="border-right: 1px solid rgba(153, 153, 153, 0.32);max-width: 200px !important;min-width: 200px !important;" v-if="display_menu">
